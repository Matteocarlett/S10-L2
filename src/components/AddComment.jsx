    ...
    try {
      const response = await fetch(
        'https://striveschool-api.herokuapp.com/api/comments',
        {
          method: 'POST',
          headers: {
            Authorization: "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NTlkNGYyYWU2Mjg4NjAwMTg4M2Y0MGYiLCJpYXQiOjE3MDQ4MDgyMzQsImV4cCI6MTcwNjAxNzgzNH0.7kxzoqVpOtDkzIGxeGOFZvppTglSRx0CCOM1zgEVHaE",
